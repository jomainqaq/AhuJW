...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-secondary navbar-dark  ">
        ...
        <ul class="navbar-nav">
            ...
            <a class="nav-link" href="javascript:void(0);" onclick="showHint(0)">公告</a>


            <!-- Dropdown -->
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle " href="javascript:void(0);" onclick="showHint(1)" id="navbardrop"
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item " href="#">个人信息修改</a>
        ...
        <div class="container">
            ...
            <form>
                <div class="form-group">
                    ...
                    <input type="pwd" class="form-control" id="email" placeholder="Old Password">
                </div>
                <div class="form-group">
    ...
    <script>
        function showHint(str) {
            ...
            xmlhttp.open("GET", "public/test.php?q=" + str, true);
            xmlhttp.send()
